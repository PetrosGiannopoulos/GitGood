...
function paletteCommands() {
  ...
  return [
    ...
    { id: 'hist.undo', title: 'Undo — History of HEAD…', group: 'History', icon: '↩',
      ...
      run: () => openUndoPanel() },
    { id: 'hist.souls', title: 'The Soul World — Deleted Branches & Lost Commits…', group: 'History', icon: '☠',
      available: hasRepo, keywords: 'graveyard recover deleted branch orphan dangling lost restore resurrect',
      run: () => openSoulWorld() },
